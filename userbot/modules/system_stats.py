...
async def amireallyalive(alive):
    ...
    output = (
        ...
        "**🎖️ [RPL v1.d](https://github.com/BianSepang/WeebProject/blob/master/LICENSE) | 👤 [WeebProject](https://github.com/BianSepang) | 📌 [Repo](https://github.com/BianSepang/WeebProject.git)**\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
