...
async def lyrics(lyric):
    ...
    if lyric.pattern_match.group(1) == "now":
        ...
        if playing is None:
            await lyric.edit("`Tidak ada informasi terkini scrobbling last.fm...`")
            return False
...
CMD_HELP.update(
    {
        "lyrics": "`.lyrics [artis] - [lagu]`"
        "\n➥  Dapatkan lirik yang cocok dengan artis dan lagu."
        "\n\n`.lyrics now`"
        "\n➥  Dapatkan lirik artis dan lagu dari scrobbling last.fm saat ini."
    }
)
